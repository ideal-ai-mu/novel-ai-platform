...
- AI 各项功能详解（续写 / 改写 / 润色 / 全章 / 灵感 / 纠错、伏笔、时间线、人物关系图、一键总结、提示词管理）见 **[AI 功能详解](docs/AI功能说明.md)**。

## 配置 AI（API）

AI 功能使用**你自己的** AI 接口，应用本身不含 AI 额度，配置一次即可长期使用。完整的 AI 功能与配置说明见 **[AI 功能详解](docs/AI功能说明.md)**。
